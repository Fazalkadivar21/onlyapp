...
const integrations: IntegrationSummary[] = [
  { type: "slack", name: "Slack", status: "disconnected", description: "Selected channels, DMs, mentions, threads, and sends." },
  { type: "whatsapp", name: "WhatsApp", status: "disconnected", description: "QR login, selected chats/groups, text and media messages." },
  { type: "github", name: "GitHub", status: "disconnected", description: "PRs, reviews, mentions, failed checks, and merge events." },
  { type: "jira", name: "Jira", status: "disconnected", description: "Active sprint, assigned tickets, status changes, and blockers." },
